...
export function useSideBar() {
  ...
  return computed(() => {
    ...
    if (frontSidebar === 'auto') return resolveAutoSidebar(headers, sidebarDepth)
    ...
    if (themeSidebar === 'auto') return resolveAutoSidebar(headers, sidebarDepth)
    return themeSidebar
  })
}

function resolveAutoSidebar(headers: any[], depth: number): DefaultTheme.SideBarItem[] {
